...
# S3 Bucket Creation
s3bucket=$(aws s3api create-bucket --bucket terraform-3-tier-app-testqa --region us-west-2 --create-bucket-configuration LocationConstraint=us-west-2 --output text)
